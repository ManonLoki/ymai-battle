...
# 用法：scripts/build_android.sh [输出路径]
set -euo pipefail
...
#   INSTALL_BUILD_TEMPLATE=1 scripts/build_android.sh
...
python3 "$PROJECT_DIR/scripts/fix_android_preset.py" "$PROJECT_DIR/export_presets.cfg"
